...
fn main() {
    let coords: (f32, f32) = (6.3, 15.0); //<- a tuple
    ...
    //
    // - Make a library file (src/lib.rs) DONE
    // - Move all the functions (except main) into the library DONE
    // - Make all the functions public with `pub` DONE
